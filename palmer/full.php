	...
	<body class="landing">
		...
		<!-- Main -->
			<section id="main" class="container">
				...
				<a id="research"></a>
				<section class="box special" id="publications">
					<header class="major">
						<h2>Publications</h2>
						<p><?php include("includes/publications2.php"); ?></p>
					</header>
					<span class="image featured"><img src="images/publications.jpg" alt="" /></span>
				</section>
				<section class="box special" id="workingpapers">
					<header class="major">
						<h2>Working Papers</h2>
						<p><?php include("includes/workingpapers2.php"); ?></p>
					</header>
					<span class="image featured"><img src="images/workingpapers.jpg" alt="" /></span>
				</section>
				<section class="box special" id="worksinprogress">
					<header class="major">
						<h2>Works in Progress</h2>
						<p><?php include("includes/worksinprogress2.php"); ?></p>
					</header>
